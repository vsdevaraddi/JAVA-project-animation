...
public class Scene_d extends Scene {
    ...
    //checks for overlapping of sceneobjects and
    //prints the position where the overlapping has happened
            ...
            for (; iterator_actor2.hasNext();) {
                ...
                if (!sceneobject2.equals(sceneobject1)) {
                    ...
                    if (bbox2.intersects(bbox1)) {
                        ...
                        System.out.println(sceneobject1.getObjName()+" Collided at x = " + point.getX() + " y = " + point.getY());
                    }
                }
            }
